...
public class LTree : MonoBehaviour
{
	...
	public float length_decay = 0.7f;
	...
	public float minimum_radius = 0.01f;
	...
	void createChildren()
	{
		...
		for(int i =0;i<num_children;i++)
		{
			...
			branches.Add(child);
			child.construct(material,progenitor,new_length,new_radius);
		}
	...
	public void reset(float l,float r)
	{
		...
		branches = new List<LTree>();
		construct(material,null, l,r);
	}
	
	public void construct(Material m,GameObject parentTree, float length, float radius)
	{
		material = m;
		contents = new GameObject();
		appearance = GameObject.CreatePrimitive(LTreeController.limbType);
		appearance.renderer.material = material;
...
//	{
//		Debug.Log("Collided");
//		appearance.transform.parent = null;
//		contents.transform.parent = null;
//		appearance.AddComponent("Rigidbody");
//	}
}
